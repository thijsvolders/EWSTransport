...
public class EWSMailTransportSender extends AbstractTransportSender
...
//     */
//    public EWSMailTransportSender() {
//        log = LogFactory.getLog(EWSMailTransportSender.class);
//    }
//
//    /**
...
//    }
    ...
    public void sendMessage(MessageContext msgCtx, String targetEPR, OutTransportInfo outTransportInfo) throws AxisFault {
        // NOP
        throw new AxisFault("Oops, EWS Mail Sender is not supported yet !");
    }
}
